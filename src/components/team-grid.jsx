...
// Full teacher profiles. Used on the About page (the homepage only teases the
// team with an avatar row).
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground text-pretty">
            Every teacher is British qualified and DBS-checked, with deep
            experience across international schools and the exam boards.
          </p>
        </div>
