...
export function Resources() {
  return (
    <section id="resources" className="py-12 sm:py-16">
      <Container>
        <Reveal className="overflow-hidden rounded-[2rem] bg-[radial-gradient(125%_95%_at_18%_8%,#123a5e_0%,#0d2340_45%,#0a1830_100%)] px-6 py-12 ring-1 ring-white/10 sm:px-10 sm:py-14">
